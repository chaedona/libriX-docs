# 애플리케이션 서버 관리
애플리케이션 서버 관리는 LibriX에 등록된 Open Liberty 서버들을 중앙에서 관리하는 기능입니다. 서버 생성, 삭제, 시작, 중지, 재시작 등의 생명주기 관리 작업과 서버 구성 설정 방법을 설명합니다.

## 목차

- [개요](#개요)
- [애플리케이션 서버 목록](#애플리케이션-서버-목록)
- [새 애플리케이션 서버 생성](#새-애플리케이션-서버-생성)
- [서버 상세 정보](#서버-상세-정보)
- [다음 단계](#다음-단계)
