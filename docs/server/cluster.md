# 클러스터 관리
클러스터 관리는 여러 애플리케이션 서버를 하나의 논리적 그룹으로 관리하는 기능입니다. 클러스터 생성, 삭제, 시작, 중지와 페일오버 정책 설정을 통해 고가용성과 확장성을 확보하는 방법을 설명합니다.
...
- [클러스터 목록](#클러스터-목록)
- [클러스터 생성](#클러스터-생성)
- [클러스터 페일오버 정책](#클러스터-페일오버-정책)
- [클러스터와 애플리케이션 서버](#클러스터와-애플리케이션-서버)
- [클러스터 설계 고려사항](#클러스터-설계-고려사항)
- [클러스터 모니터링](#클러스터-모니터링)
- [클러스터 문제 해결](#클러스터-문제-해결)
- [클러스터 운영 모범 사례](#클러스터-운영-모범-사례)
- [다음 단계](#다음-단계)
