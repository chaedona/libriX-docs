# 웹서버 관리
웹서버 관리는 LibriX에 등록된 웹서버들을 중앙에서 관리하는 기능입니다. 웹서버 등록, 삭제, 시작, 중지와 플러그인 생성 및 전파를 통해 애플리케이션 서버와의 연동 방법을 설명합니다.

## 목차

- [개요](#개요)
- [웹서버 목록](#웹서버-목록)
- [웹서버 상태 모니터링](#웹서버-상태-모니터링)
- [웹서버와 애플리케이션 서버 연동](#웹서버와-애플리케이션-서버-연동)
- [새 웹서버 작성](#새-웹서버-작성)
- [웹서버 상세 정보](#웹서버-상세-정보)
- [다음 단계](#다음-단계)
...
- **관리형 노드**: LibriX가 직접 제어할 수 있는 노드입니다. 플러그인 전파가 자동으로 수행되며, 웹서버의 시작/중지도 관리콘솔에서 가능합니다 (계정권한에 따라 가능함).

- **비관리형 노드**: LibriX에서 직접 제어할 수 없는 노드입니다. 이 경우 플러그인 구성 파일을 수동으로 복사 해야 합니다.
