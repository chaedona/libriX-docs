# 세션 도메인 관리
세션 도메인은 HTTP 세션 데이터를 공유하는 서버 그룹을 정의하는 논리적 단위입니다. LibriX 관리콘솔에서 세션 도메인을 생성하고 관리하며, 세션 서버와 애플리케이션 서버가 동일한 세션 도메인에 속해 세션 데이터를 공유하는 방법을 설명합니다.
...
- [세션 도메인 목록](#세션-도메인-목록)
- [세션 도메인 생성](#세션-도메인-생성)
- [세션 도메인 상세 정보](#세션-도메인-상세-정보)
- [세션 도메인 설계 고려사항](#세션-도메인-설계-고려사항)
- [세션 도메인과 JCache 클러스터](#세션-도메인과-jcache-클러스터)
- [세션 도메인 모니터링](#세션-도메인-모니터링)
- [세션 도메인 문제 해결](#세션-도메인-문제-해결)
- [세션 도메인 마이그레이션](#세션-도메인-마이그레이션)
- [모범 사례](#모범-사례)
- [다음 단계](#다음-단계)
