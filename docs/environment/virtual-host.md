...
가상호스트(Virtual Host)는 하나의 Liberty 서버에서 여러 도메인이나 호스트 이름으로 애플리케이션을 제공할 수 있게 해주는 기능입니다. 하나의 서버에서 여러 도메인/호스트 이름 처리, 애플리케이션별 네트워크 격리, 포트 및 호스트 이름 기반 라우팅 방법을 설명합니다.

## 목차

- [개요](#개요)
- [가상호스트 메인 화면](#가상호스트-메인-화면)
- [가상호스트 개념](#가상호스트-개념)
- [가상호스트 사용 사례](#가상호스트-사용-사례)
- [가상호스트 생성](#가상호스트-생성)
- [호스트 별명 관리](#호스트-별명-관리)
- [MIME 유형 관리](#mime-유형-관리)
- [변경사항 저장 및 검토](#변경사항-저장-및-검토)
- [Liberty server.xml 구성](#liberty-serverxml-구성)
- [애플리케이션에 가상호스트 매핑](#애플리케이션에-가상호스트-매핑)
- [문제 해결](#문제-해결)
- [모범 사례](#모범-사례)
