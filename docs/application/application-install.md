...
- 배포된 애플리케이션을 관리하려면 [설치된 애플리케이션 관리](installed-applications.md) 문서를 참조하십시오.
- 애플리케이션 성능을 모니터링하려면 [애플리케이션 모니터링](application-monitoring.md) 문서를 참조하십시오.
- 데이터소스를 구성하려면 [데이터소스 관리](datasource.md) 문서를 참조하십시오.
- 클러스터에 애플리케이션을 배포하려면 [클러스터 관리](cluster.md) 문서를 참조하십시오.
